...
--
-- Standalone bootstrap for schema version 20. Equivalent to running
...
INSERT INTO settings (site_id, skey, svalue) VALUES (0, 'schema_version', '20');
INSERT INTO schema_migrations (version, name, checksum, status, started_at, finished_at)
VALUES (20, 'bootstrapped from supabase/schema.sql', '', 'installed', now(), now());
