<?php /* The Burrard Brief — section front (foundation build; $cat, $posts,
...
<div class="bb-wrap bb-section">
  ...
  <?php endforeach; ?>
  <?php if (!$posts): ?>
  <div class="bb-empty" style="margin-top:16px">Nothing on this desk yet — the newsroom is on it.</div>
  <?php endif; ?>
