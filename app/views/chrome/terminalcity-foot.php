<?php
/* Terminal City Times — footer chrome (foundation build). Closes <main>
   and the document. */
?>
</main>
<footer class="tc-foot">
  <div class="in">
    <div>
      <div class="name">Terminal City Times</div>
    ...
    <div>
      <h4>Follow</h4>
      <a href="<?= e(url('newsletter/')) ?>"><?= e(setting('newsletter_heading', 'The Morning Departure')) ?></a>
